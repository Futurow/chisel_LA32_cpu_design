...
```sh
git clone git@github.com:Futurow/chisel_LA32_cpu_design.git
cd chisel_LA32_cpu_design
```
...
#### Commit your changes
```sh
git commit -m 'Starting chisel_LA32_cpu_design'
...
```sh
mill chisel_LA32_cpu_design.test
```
