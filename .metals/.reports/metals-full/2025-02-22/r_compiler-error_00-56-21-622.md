...
class EXE_stage extends Module {
  ...
  div_sign.io.s_axis_divisor_tvalid:=div_op()
  div_sign.io.s_axis_dividend_tvalid:=div_op()
  //无符号除法
  div_unsign.io.aclk:=clock
  div_unsign.io.s_axis_dividend_tdata:=src1
  div_unsign.io.s_axis_divisor_tdata:=src2
